rec {
  ...
  people_pubkeys = {
    ...
    motiejus_macworx = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIIn+TP17ocwY9IDCoyEe85F/G17rRIKOS9kR0Wlx3rm";
    motiejus_vno2 = "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBDkxK1VtxHZfZD6uFpRDRbU6vEM2Tyor1ZVCHHr+lp/n5xfQrVlaho+SlNY6ybB2+ZJI0RUVJksw+VXCq1PhVu4= motiejus@vno2-desk2";
  };
  ...
  jakstysLTZone =
    ...
    ''
      ...
      _acme-challenge                  CNAME     _acme-endpoint
      _acme-endpoint                      NS     ns._acme-endpoint
