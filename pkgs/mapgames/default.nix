{
  ...
  fetchurl,
  runCommand,
  # nixpkgs-unstable package set (exposed by the flake overlay). Only the
  # deployer-side compression tools (zstd/brotli/zopfli) come from here; the
  # compiler comes from zigpkgs below.
  pkgs-unstable,
  ...
  mapsRev ? "3983320eb265fe30e52b50a32e56f4953f147537f8abe842eaea35251aa7a338",
  mapsSrc ? null,
  ...
  maps =
    if mapsSrc != null then
      ...
      fetchgit {
        ...
        hash = "sha256-d4WYD6epurWuGQ7y/SpkzYUQCfByrBhsS/90OaXImyc=";
      };
